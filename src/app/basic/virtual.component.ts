  ...
  template: `
    <div>
      <h3>
        ...
        <small>
          <a
            href="https://github.com/ng-nest-datatable/blob/master/src/app/basic/virtual.component.ts"
            target="_blank"
          >
            Source
          </a>
      ...
      >
        ...
        <ngn-datatable-column name="Row Height" prop="height" [width]="80"> </ngn-datatable-column>
      </ngn-datatable>
    </div>
  `
})
